 ...
 * @author chareq
 */
public class Raport5 extends javax.swing.JFrame {
    String wlasciciel;
    ...
    //Funkcja służąca do uzupełnienia pola wyboru dla nazwy stacji wartościami z bazy
    public void stationIdFillData() {
        try {
            ...
            String query = "SELECT Nazwa FROM Stacje";
            java.sql.ResultSet rs = stat.executeQuery(query);
            
            while (rs.next()) {
                NazwaS.addItem(rs.getString("Nazwa"));
            }
    ...
    private void initComponents() {
        ...
        NazwaS = new javax.swing.JComboBox<>();
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tytul1, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(back1, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(25, 25, 25))
        );
        ...
        jLabel1.setText("Nazwa stacji:");

        NazwaS.setFont(new java.awt.Font("Cantarell", 0, 16)); // NOI18N
        NazwaS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NazwaSActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(14, 14, 14)
                .addComponent(NazwaS, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(173, 173, 173))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(NazwaS, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel1))
    ...
    private void NazwaSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NazwaSActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NazwaSActionPerformed
    ...
    private void generateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateActionPerformed
        try {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:firebirdsql://localhost:3050//databases/skp.fdb", "SYSDBA", "Czarek08#")) {
                String reportPath = "/databases/Raporty/Raport5.jrxml";
                String nazwa_s = NazwaS.getSelectedItem().toString();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Raport5().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JComboBox<String> NazwaS;
